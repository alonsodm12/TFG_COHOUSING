...
/*
 * Clase encargada de la seguridad general de la aplicación
 * 
 * Se va a encargar de definir el filtro de seguridad
 * encargado de validar el token en cada peticion a la API
 */
